...
public class SaveSystem : MonoBehaviour
{
    ...
    public void SaveSystem_SAVE()
    {
        ...
        if (Mind.para_progress > data_PROGRESS_para)
        {
            content += Mind.para_progress.ToString() + "/";
        } else
        {
            content += data_PROGRESS_para.ToString() + "/";
        }
    ...
    public void SaveSystem_LOAD()
    {
        ...
        Mind.para_progress = int.Parse(collective_extraction_PROGRESS[2]);
        data_PROGRESS_para = int.Parse(collective_extraction_PROGRESS[2]);
        ...
        if (collective_extraction_ENDING[3] == "False")
        {
            Mind.seen_stolen_ending = false;
            data_ENDING_stolen = 0;
        } else
        {
    ...
    void Update()
    {
        ...
        if (should_Autosave)
        {
            ...
            if (ending_gotten == "Stolen") {Mind.seen_stolen_ending = true;}
            if (ending_gotten == "Stolen") {Mind.para_progress = 4;}
            if (ending_gotten == "Stolen") {data_PROGRESS_para = 4;}
            SaveSystem_SAVE();
